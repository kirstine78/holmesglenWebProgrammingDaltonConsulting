        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col_10">
                    ...
                    {
                        validateConsultant(addrecord);  //function is in validate_data.php file
						
                        if ($booOk)
                        {						
                            //Redirect to the Consultants page
                            header("Location: consultants.php?SUCCESS_MESSAGE=addDone");
                        }
                    }				
                    ...
                    echo "<form action='add_consultant.php' method='post'>";
                    
                    echo "<div class='row'>";
                    
                    echo "<table id='dalton'>";
                    
                    echo "<tr><th>Consultant ID *</th><td><input type='text' name='strConsultantId' maxlength='9' value='".htmlspecialchars($strConsultantId, ENT_QUOTES)."' /></td>";					
					if ($booConsultantId)
                        echo "<td class='validationError'>Please enter a Consultant ID. Exactly 9 characters (3 letters followed by 6 digits)!</td>";
					else
						echo "<td><em>example: ABC123456</em></td>";
						
                        
                    echo "</tr><tr><th>First name *</th><td><input type='text' name='strConsultantFirstname' maxlength='20' size='20' value='".htmlspecialchars($strConsultantFirstname, ENT_QUOTES)."' /></td>";
